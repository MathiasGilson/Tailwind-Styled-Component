...
export type Equals<T, U> = IsAny<T, never, IsAny<U, never, [T] extends [U] ? ([U] extends [T] ? any : never) : never>>
export type IsNotAny<T> = IsAny<T, never, any>
export type EnsureUnknown<T extends any> = IsUnknown<T, any, never>
export type EnsureAny<T extends any> = IsAny<T, any, never>
